...
} from "./chunk-GNTF3GGU.js";
import {
  DumpDataAsync
} from "./chunk-QNZXXHKV.js";
import {
  Scene
...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRgbdTextureAsync = async () => {
      ...
      if (isWebGpu) {
        ...
        await import("./rgbdDecode.fragment-36KWXA4B.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-RXYUFRMK.js");
    } else {
...
//# sourceMappingURL=chunk-MMDLKO6F.js.map
