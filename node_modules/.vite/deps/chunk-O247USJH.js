...
import {
  ...
  RenderTargetTexture,
  RenderingManager
} from "./chunk-6SGYX6A7.js";
import {
  EffectWrapper
} from "./chunk-DBFLTGBA.js";
import {
...
import {
  Texture
} from "./chunk-BFASMWXC.js";
import {
  ShadowLight
} from "./chunk-CTEZHGPE.js";
import {
  Light
} from "./chunk-WHP76M2N.js";
import {
  Node
} from "./chunk-SQHPNIL3.js";
import {
  UniformBuffer
} from "./chunk-MFEJP644.js";
import {
  Tools
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-7EHSRJYY.js"),
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-XA3RKTRG.js"),
...
var DepthRenderer = class _DepthRenderer {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-QS5O2AYC.js"), import("./depth.fragment-74JJZEU3.js")]);
    } else {
      await Promise.all([import("./depth.vertex-PWJXT4CC.js"), import("./depth.fragment-ZUCKBG2S.js")]);
    }
    this._shadersLoaded = true;
  }
  /**
...
//# sourceMappingURL=chunk-O247USJH.js.map
