...
import {
  ...
  RenderTargetTexture,
  RenderingManager
} from "./chunk-YV2ERG4C.js";
import {
  EffectWrapper
} from "./chunk-E4KEUATZ.js";
import {
...
import {
  ...
  PointerInfo,
  PointerInfoPre
} from "./chunk-FFSL3EOD.js";
import {
  ShadowLight
} from "./chunk-UM7KNMDO.js";
import {
  Camera,
  Stage
} from "./chunk-Y3ZORSKG.js";
import {
  SmartArray,
...
import {
  BoundingInfo,
  PickingInfo
} from "./chunk-UYD7E5G5.js";
import {
  DrawWrapper
} from "./chunk-BZYXM5GR.js";
import {
  VertexBuffer
} from "./chunk-2PJUNA7K.js";
import {
  Light
} from "./chunk-EN45ULSZ.js";
import {
  Texture
...
import {
  Node
} from "./chunk-7VHMI7MT.js";
import {
  UniformBuffer
} from "./chunk-R4434RG6.js";
import {
  Tools
} from "./chunk-OMSVXDAU.js";
import {
  Engine
} from "./chunk-37M4KR7N.js";
import {
  PerfCounter
} from "./chunk-LJSODA3L.js";
import {
  Frustum
} from "./chunk-3AXNY2PD.js";
import {
  Mix
...
var ThinBlurPostProcess = class _ThinBlurPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./kernelBlur.fragment-MQYUSO4O.js"), import("./kernelBlur.vertex-2YD63KSN.js")]));
    } else {
      list.push(Promise.all([import("./kernelBlur.fragment-MCKCCBRW.js"), import("./kernelBlur.vertex-MOIJE5IS.js")]));
    }
  }
  /**
...
var ShadowGenerator = class _ShadowGenerator {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        import("./shadowMap.fragment-NH2NBCC7.js"),
        import("./shadowMap.vertex-WTUPOIAU.js"),
        import("./depthBoxBlur.fragment-NU4DEFPO.js"),
        import("./shadowMapFragmentSoftTransparentShadow-ZRGQR2HE.js")
      ]);
    } else {
      await Promise.all([
        import("./shadowMap.fragment-HZ5EIFS6.js"),
        import("./shadowMap.vertex-LZC3LWDM.js"),
        import("./depthBoxBlur.fragment-AGGXNQHH.js"),
        import("./shadowMapFragmentSoftTransparentShadow-PSEQXQYN.js")
      ]);
    }
...
var DepthRenderer = class _DepthRenderer {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-RQY42O7A.js"), import("./depth.fragment-74JJZEU3.js")]);
    } else {
      await Promise.all([import("./depth.vertex-HO3PR2IF.js"), import("./depth.fragment-ZUCKBG2S.js")]);
    }
    this._shadersLoaded = true;
  }
  /**
...
var ThinMinMaxReducerPostProcess = class _ThinMinMaxReducerPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./minmaxRedux.fragment-QQXDHOQJ.js"));
    } else {
      list.push(import("./minmaxRedux.fragment-CVIUI5DU.js"));
    }
  }
...
var Scene = class _Scene {
  ...
  constructor(engine, options) {
    ...
    if (options == null ? void 0 : options.floatingOriginMode) {
...
//# sourceMappingURL=chunk-XLIJDRKV.js.map
