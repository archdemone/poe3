import{aj as e}from"./main-cbd8a0ec.js";const t="bonesDeclaration",s=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=s);const m={name:t,shader:s},I=Object.freeze(Object.defineProperty({__proto__:null,bonesDeclarationWGSL:m},Symbol.toStringTag,{value:"Module"})),n="bakedVertexAnimationDeclaration",d=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=d);const i="instancesVertex",u=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=u);const r="bonesVertex",f=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=f);const o={name:r,shader:f},x=Object.freeze(Object.defineProperty({__proto__:null,bonesVertexWGSL:o},Symbol.toStringTag,{value:"Module"})),a="bakedVertexAnimation",c=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=c);export{x as a,I as b};
