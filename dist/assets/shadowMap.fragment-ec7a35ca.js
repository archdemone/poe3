import{aj as e}from"./main-cbd8a0ec.js";import"./packingFunctions-0a702bbf.js";import"./clipPlaneFragment-d09d76ba.js";const t="bayerDitherFunctions",S=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=S);const n="shadowMapFragmentExtraDeclaration",s=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=s);const a="shadowMapFragment",i=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=i);const o={name:a,shader:i},M=Object.freeze(Object.defineProperty({__proto__:null,shadowMapFragmentWGSL:o},Symbol.toStringTag,{value:"Module"})),r="shadowMapPixelShader",f=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=f);const d={name:r,shader:f},c=Object.freeze(Object.defineProperty({__proto__:null,shadowMapPixelShaderWGSL:d},Symbol.toStringTag,{value:"Module"}));export{c as a,M as s};
