import{aj as e}from"./main-cbd8a0ec.js";import"./mainUVVaryingDeclaration-e71dada2.js";import"./helperFunctions-74d3af2b.js";import"./logDepthFragment-c0e5807e.js";import"./clipPlaneFragment-d09d76ba.js";import"./logDepthDeclaration-ed7310b6.js";import"./fogFragmentDeclaration-5c343249.js";const d="prePassDeclaration",P=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=P);const c="oitDeclaration",X=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=X);const t="lightUboDeclaration",x=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=x);const _={name:t,shader:x},K=Object.freeze(Object.defineProperty({__proto__:null,lightUboDeclarationWGSL:_},Symbol.toStringTag,{value:"Module"})),v="ltcHelperFunctions",y=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
vec3f( 0,1,0 ),
vec3f( 0,0,1 )
);result.Diffuse+=LTCEvaluate( normal,viewDir,position,mInvEmpty,rectCoords0,rectCoords1,rectCoords2,rectCoords3 );return result;}`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=y);const u="clusteredLightingFunctions",M=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=M);const r="lightsFragmentFunctions",w=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=w);const F={name:r,shader:w},ee=Object.freeze(Object.defineProperty({__proto__:null,lightsFragmentFunctionsWGSL:F},Symbol.toStringTag,{value:"Module"})),a="shadowsFragmentFunctions",L=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=L);const R={name:a,shader:L},te=Object.freeze(Object.defineProperty({__proto__:null,shadowsFragmentFunctionsWGSL:R},Symbol.toStringTag,{value:"Module"})),p="samplerFragmentDeclaration",N=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=N);const h="fresnelFunction",O=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=O);const i="reflectionFunction",C=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=C);const b={name:i,shader:C},re=Object.freeze(Object.defineProperty({__proto__:null,reflectionFunctionWGSL:b},Symbol.toStringTag,{value:"Module"})),o="bumpFragmentMainFunctions",T=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=T);const W={name:o,shader:T},ae=Object.freeze(Object.defineProperty({__proto__:null,bumpFragmentMainFunctionsWGSL:W},Symbol.toStringTag,{value:"Module"})),f="bumpFragmentFunctions",I=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=I);const z={name:f,shader:I},ie=Object.freeze(Object.defineProperty({__proto__:null,bumpFragmentFunctionsWGSL:z},Symbol.toStringTag,{value:"Module"})),n="bumpFragment",E=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=E);const U={name:n,shader:E},oe=Object.freeze(Object.defineProperty({__proto__:null,bumpFragmentWGSL:U},Symbol.toStringTag,{value:"Module"})),m="decalFragment",H=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=H);const S="depthPrePass",G=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=G);const s="lightFragment",D=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=D);const V={name:s,shader:D},fe=Object.freeze(Object.defineProperty({__proto__:null,lightFragmentWGSL:V},Symbol.toStringTag,{value:"Module"})),g="oitFragment",k=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=k);const l="defaultPixelShader",A=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[l]||(e.ShadersStoreWGSL[l]=A);const B={name:l,shader:A},ne=Object.freeze(Object.defineProperty({__proto__:null,defaultPixelShaderWGSL:B},Symbol.toStringTag,{value:"Module"}));export{ee as a,ae as b,ie as c,oe as d,fe as e,ne as f,K as l,re as r,te as s};
